...
export default function NoSQLDashboardPage() {
  ...
  useEffect(() => {
    async function fetchUserData() {
      try {
        const response = await fetch("/api/nosql/user", {
          method: "GET",
          headers: {
  ...
  async function onUpdate(values: z.infer<typeof updateFormSchema>) {
    ...
    try {
      const response = await fetch("/api/nosql/update-user", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  async function onDelete() {
    ...
    try {
      const response = await fetch("/api/nosql/delete-user", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="mb-8 flex items-center justify-between">
        <h1 className="text-3xl font-bold">NoSQL User Dashboard</h1>
        <Link href="/">
